// Copied from and inspired by .NET Aspire ResourceSnapshot.cs
...
internal abstract class ResourceSnapshot
{
    ...
    public static Value ConvertToValue(object? value)
    {
        return value switch
        {
            ...
            IEnumerable<string> list => Value.ForList([.. list.Select(Value.ForString)]),
            IEnumerable<int> list => Value.ForList([.. list.Select(i => Value.ForNumber(i))]),
            null => Value.ForNull(),
