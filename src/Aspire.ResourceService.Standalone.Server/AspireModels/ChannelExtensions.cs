// Directly copied from .NET Aspire's ChannelExtensions.cs
...
internal static class ChannelExtensions
{
    ...
    /// <returns></returns>
    public static async IAsyncEnumerable<IReadOnlyList<T>> GetBatchesAsync<T>(this Channel<T> channel, TimeSpan? minReadInterval = null, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
